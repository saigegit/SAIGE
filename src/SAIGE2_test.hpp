...
class SAIGE2Class
{
  ...
  SAIGE2Class(
    ...
    // Destructor (ADD THIS DECLARATION)
    ~SAIGE2Class();

    // Copy constructor (ADD THIS DECLARATION)
    SAIGE2Class(const SAIGE2Class& other);

    // Assignment operator (ADD THIS DECLARATION)
    SAIGE2Class& operator=(const SAIGE2Class& other);
