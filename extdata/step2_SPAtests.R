...
option_list <- list(
 ...
 make_option("--minGroupMAC_in_BurdenTest", type="numeric", default=5,
  ...
  make_option("--maxMAF_in_groupTest", type="character",default="0.01",
  ...
  make_option("--MACCutoff_to_CollapseUltraRare", type="numeric", default=10.5,
    help="MAC cutoff to collpase the ultra rare variants (<= MACCutoff_to_CollapseUltraRare) in the set-based association tests. By default, 10.5"),
  make_option("--cateVarRatioMinMACVecExclude",type="character", default="10.5,20.5",
    help="Optional. vector of float. Lower bound for MAC categories. The length equals to the number of MAC categories for variance ratio estimation. [default='10.5,20.5']"),
