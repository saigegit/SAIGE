...
option_list <- list(
 ...
 make_option("--pcgforUhatforSurvAnalysis", type="logical",default=FALSE,
  ...
  make_option("--usePCGwithSparseGRM", type="logical", default=FALSE,
    help="Optional. Whether to use PCG for inverse of the sparse GRM if --useSparseGRMtoFitNULL=TRUE. [default='FALSE']."),
...
}else if(packageVersion("SAIGE")>="1.4.0" & packageVersion("SAIGE")<"1.4.5"){
fitNULLGLMM(plinkFile=opt$plinkFile,
            bedFile=opt$bedFile,
            bimFile=opt$bimFile,
            famFile=opt$famFile,
