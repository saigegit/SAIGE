...
- The `--build-arg` flag is optional : `BASE_IMAGE` will default to ubuntu:22.04 LTS. For short term builds, specify the latest intermediate release for updated packages.
